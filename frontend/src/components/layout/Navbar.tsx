...
const Navbar: React.FC = () => {
  ...
  return (
    <header className="h-16 border-b border-slate-800 bg-[#0f1629]/80 flex items-center justify-between px-6 backdrop-blur-md z-20 sticky top-0">
      ...
      <div className="flex-1 max-w-md relative hidden md:block">
        ...
        <input
          type="text"
          className="block w-full pl-10 pr-3 py-2 border border-slate-700 rounded-lg leading-5 bg-slate-900/50 text-slate-300 placeholder-slate-500 focus:outline-none focus:border-cyan-500 focus:ring-1 focus:ring-cyan-500 sm:text-sm transition-colors"
      ...
      <div className="flex items-center space-x-4 ml-auto">
        ...
        <div className="relative">
          ...
          >
            ...
            {user?.avatar_url ? (
              <img src={user.avatar_url} alt="Profile" className="h-9 w-9 rounded-full border border-slate-600 group-hover:border-cyan-400 transition-colors" />
            ) : (
              <div className="h-9 w-9 rounded-full bg-slate-700 border border-slate-600 flex items-center justify-center group-hover:border-cyan-400 transition-colors">
